...
Для удобства тестирования API, вы можете использовать коллекцию в Postman. Коллекция доступна по следующей ссылке:

[ChocoNet API Postman Collection](https://www.postman.com/lunch-layout/choconet/overview)

Импортируйте коллекцию в Postman и используйте для тестирования доступных эндпоинтов.
